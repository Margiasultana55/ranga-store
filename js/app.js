...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image"  src=${image}></img>
      ...
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="rounded border-0 p-2 add-btn">add to cart</button>
      <button id="details-btn" class="rounded border-0 p-2 details-btn">Details</button></div>
      `;
